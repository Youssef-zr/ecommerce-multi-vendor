    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                $editBtn = "<a href='" . route('admin.dashboard.child-category.edit', $query->id) . "' class='btn btn-primary btn-sm'><i class='fa fa-edit'></i></a>";
                $deleteBtn = "<a href='" . route('admin.dashboard.child-category.destroy', $query->id) . "' class='btn btn-danger btn-sm delete-btn'><i class='fa fa-trash'></i></a>";
            ...
            ->rawColumns(['name', 'status', "action","category","subCategory"])
            ->setRowId('id');
    }
