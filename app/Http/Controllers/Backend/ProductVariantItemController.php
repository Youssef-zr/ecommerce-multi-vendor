...
class ProductVariantItemController extends Controller
{
    ...
    public function index(ProductVariantItemDataTable $datatable, $productId, $variantId)
    {
        ...
        return $datatable->render('admin.product.variant-item.index', compact('variant', 'product'));
    }
    ...
    public function store(StoreVariantItemRequest $request, $variantId)
    {
        ...
        return to_route('admin.dashboard.product-variant-item.index', ["productId" => $variant->product_id, "variantId" => $variant->id]);
    }
    ...
    public function edit($variantItemId)
    {
        ...
        return view('admin.product.variant-item.edit', compact('variantItem', 'variant'));
    }
    ...
    public function update(UpdateVariantItemRequest $request, $variantItemId)
    {
        ...
        return to_route('admin.dashboard.product-variant-item.index', ["productId" => $variantItem->product_id, "variantId" => $variantItem->variant_id]);
    }
