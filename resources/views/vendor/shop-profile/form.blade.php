<div class="row">
    ...
    @if (isset($vendor) and File::exists($vendor->banner))
        <div class="col-12">
            <div class="form-group wsus__dash_pro_single">
    ...
    <div class="col-12">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('banner') ? ' has-error' : '' }}">
    ...
    <!-- shop_name field -->
    <div class="col-12">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('shop_name') ? ' has-error' : '' }}">
    ...
    <!-- email field -->
    <div class="col-12">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('email') ? ' has-error' : '' }}">
    ...
    <!-- phone field -->
    <div class="col-12">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('phone') ? ' has-error' : '' }}">
    ...
    <!-- adress field -->
    <div class="col-12">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('adress') ? ' has-error' : '' }}">
    ...
    <div class="col-12">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('fb_link') ? ' has-error' : '' }}">
    ...
    <!-- twitter field field -->
    <div class="col-12">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('tw_link') ? ' has-error' : '' }}">
    ...
    <div class="col-12">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('insta_link') ? ' has-error' : '' }}">
