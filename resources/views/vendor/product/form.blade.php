...
<div class="form-group wsus__dash_pro_single{{ $errors->has('thumb_image') ? ' has-error' : '' }}">
...
<!-- name field -->
<div class="form-group wsus__dash_pro_single{{ $errors->has('name') ? ' has-error' : '' }}">
...
<div class="row">
    ...
    <!-- main category field -->
    <div class="col-md-4">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('category_id') ? ' has-error' : '' }}">
    ...
    <div class="col-md-4">
        ...
        @endphp
        <div class="form-group wsus__dash_pro_single{{ $errors->has('sub_category_id') ? ' has-error' : '' }}">
    ...
    <div class="col-md-4">
        ...
        @endphp
        <div class="form-group wsus__dash_pro_single{{ $errors->has('child_category_id') ? ' has-error' : '' }}">
...
<!-- Brands field -->
<div class="form-group wsus__dash_pro_single{{ $errors->has('brand_id') ? ' has-error' : '' }}">
...
<!-- sku field -->
<div class="form-group wsus__dash_pro_single{{ $errors->has('sku') ? ' has-error' : '' }}">
...
<div class="row">
    ...
    <div class="col-12 col-md-6">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('price') ? ' has-error' : '' }}">
    ...
    <!-- offer_price field -->
    <div class="col-12 col-md-6">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('offer_price') ? ' has-error' : '' }}">
...
<div class="row">
    ...
    <div class="col-12 col-md-6">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('offer_start_date') ? ' has-error' : '' }}">
            {!! Form::label('offer_start_date', 'Offer start date', ['class' => 'form-label']) !!}
            {!! Form::date('offer_start_date', old('offer_start_date'), [
                'class' => 'form-control',
            ]) !!}
            @if ($errors->any())
    ...
    <div class="col-12 col-md-6">
        <div class="form-group wsus__dash_pro_single{{ $errors->has('offer_end_date') ? ' has-error' : '' }}">
            {!! Form::label('offer_end_date', 'Offer end date', ['class' => 'form-label']) !!}
            {!! Form::date('offer_end_date', old('offer_end_date'), [
                'class' => 'form-control',
            ]) !!}
            @if ($errors->any())
...
<!-- qty field -->
<div class="form-group wsus__dash_pro_single{{ $errors->has('qty') ? ' has-error' : '' }}">
...
<!-- video_link field -->
<div class="form-group wsus__dash_pro_single{{ $errors->has('video_link') ? ' has-error' : '' }}">
...
<div class="form-group wsus__dash_pro_single{{ $errors->has('short_description') ? ' has-error' : '' }}">
...
<div class="form-group mb-4 textarea-field{{ $errors->has('long_description') ? ' has-error' : '' }}">
...
<!-- product type -->
<div class="form-group wsus__dash_pro_single{{ $errors->has('product_type') ? ' has-error' : '' }}">
...
<!-- seo_title field -->
<div class="form-group wsus__dash_pro_single{{ $errors->has('seo_title') ? ' has-error' : '' }}">
...
<div class="form-group wsus__dash_pro_single{{ $errors->has('seo_description') ? ' has-error' : '' }}">
...
<!-- status field -->
<div class="form-group wsus__dash_pro_single{{ $errors->has('status') ? ' has-error' : '' }}">
        ...
        $(() => {
            ...
            $(".main-category").on('change', function() {
                ...
                if (mainCategoryId != "") {
                    ...
                    $.ajax({
                        url: "{{ route('vendor.dashboard.get-subcategories') }}",
                        data: {
                            mainCategoryId,
                        },
                        success(res) {
            ...
            $(".sub-category").on('change', function() {
                ...
                if (subCategoryId != "") {
                    ...
                    $.ajax({
                        url: "{{ route('vendor.dashboard.get-childCategories') }}",
                        data: {
                            subCategoryId,
                        },
                        success(res) {
